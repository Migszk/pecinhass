...
local Window = OrionLib:MakeWindow({Name = "Pecinhas Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Pecinhas Hub"})
...
W:AddLabel("[+] Pecinhas Hub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Pecinhas Hub(Noitification)",
